...
public class ReplayManagerImpl {
    ...
    public void openReplayList(Player p) {
        ...
        for (ReplayEntry e : list) {
            ...
            List<String> lore = new ArrayList<String>();
            lore.add(ChatColor.GRAY + "Mode: " + ChatColor.YELLOW + e.getMode());
            lore.add(ChatColor.GRAY + "Map: " + ChatColor.YELLOW + e.getMap());
            lore.add(ChatColor.GRAY + "Server: " + ChatColor.YELLOW + e.getServer());
            lore.add(ChatColor.GRAY + "Date: " + ChatColor.YELLOW + dateFormat.format(new Date(e.getCreatedAt())));
            lore.add(" ");
            lore.add(ChatColor.GREEN + "Click to watch this replay.");
            im.setLore(lore);
    ...
    public void playReplay(Player p, String id) {
        ...
        p.performCommand("replay play " + id);
    }
