    ...
    public void onClick(InventoryClickEvent e) {
        ...
        if (title.equalsIgnoreCase(mainTitle)) {
            ...
            switch (e.getRawSlot()) {
                ...
                case 13: mode = GameMode.BOXING;   break;
                case 14: mode = GameMode.NODEBUFF; break;
                case 15: mode = GameMode.OP;       break;
                case 16: mode = GameMode.SUMO;     break;
                case 17: mode = GameMode.UHC;      break;
                default: break;
            }
            if (mode == null) return;
