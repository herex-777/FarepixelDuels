...
import me.herex.farepixelduels.replay.ReplayManager;
...
public class FarepixelDuels extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // AFTER statsManager / coinManager are set up
        ...
        getCommand("quests").setExecutor(new me.herex.farepixelduels.commands.QuestsCommand(questManager));
        ...
        getServer().getPluginManager().registerEvents(new me.herex.farepixelduels.listeners.QuestGUIListener(questManager), this);

        pm.registerEvents(new JoinListener(this), this);
        pm.registerEvents(new BuildProtectionListener(this), this);

        // Replay GUI
        pm.registerEvents(new ReplayGUIListener(this, (ReplayManagerImpl) replayManager), this);
