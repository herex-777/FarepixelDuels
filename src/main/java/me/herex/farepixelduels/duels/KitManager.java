...
public class KitManager {
    ...
    public void savePlayerKit(Player p, GameMode mode, ItemStack[] contents) {
        // If you implement DB-backed player kits, wire it here:
        if (playerKits != null) {
            // TODO: implement this method in your PlayerKitManager to store kit in DB
            // playerKits.save(p, mode, Arrays.asList(contents));
        } else {
            // fallback: save as global kit
