...
public class QuestManager {
    ...
    public void handleQuestStart(Player player, QuestDefinition quest) {
    }
    ...
    public void handleQuestClick(Player p, QuestDefinition q) {
        ...
        p.sendMessage(cc("&cYou have claimed the rewards for " + q.getDisplayName() + "&a!"));
    }
    ...
    private void applyGlow(ItemMeta im, boolean glow) {
        if (glow) {
            im.addEnchant(org.bukkit.enchantments.Enchantment.DURABILITY, 1, true);
        }
    }
